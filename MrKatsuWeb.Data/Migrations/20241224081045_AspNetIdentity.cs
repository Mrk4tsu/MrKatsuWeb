    ...
    public partial class AspNetIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime(6)",
                nullable: false,
                defaultValue: new DateTime(2024, 12, 24, 8, 10, 45, 3, DateTimeKind.Utc).AddTicks(2740),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_approlesclaims", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_appuserroleclaims", x => new { x.RoleId, x.UserId });
                })
                .Annotation("MySql:CharSet", "utf8mb4");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                oldClrType: typeof(DateTime),
                oldType: "datetime(6)",
                oldDefaultValue: new DateTime(2024, 12, 24, 8, 10, 45, 3, DateTimeKind.Utc).AddTicks(2740));
        }
    }
}
